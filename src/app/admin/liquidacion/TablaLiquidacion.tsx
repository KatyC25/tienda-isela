...
export default function TablaLiquidacion({
  ...
  const handleAplicar = async () => {
    ...
    if (selectedIds.length === 0)
      return toast.error("Selecciona productos primero");
              ...
              <th className="p-4 w-10">
                <Checkbox
                  checked={
                    ...
                    selectedIds.length === productosFiltrados.length
                  }
            ...
            {productosFiltrados.length === 0 ? (
              ...
              productosFiltrados.map((prod) => {
                ...
                return (
                  <tr
                    key={prod.id}
                    className={`border-b hover:bg-slate-50 transition-colors ${isSelected ? "bg-pink-50/50" : ""}`}
                  >
                    <td className="p-4">
                      <Checkbox
                        checked={isSelected}
